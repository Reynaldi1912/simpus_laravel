                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <label class="css-control css-control-lg css-control-primary css-radio">
                                                <input type="radio" class="css-control-input" name="radio-group12" value="0" onchange="checkedFunc();" checked>
                                                <span class="css-control-indicator"></span> Approve
                                            </label>
                                            <label class="css-control css-control-lg css-control-primary css-radio">
                                                <input type="radio" class="css-control-input" name="radio-group12" value="1" onchange="checkedFunc();">
                                        ...
                                        <div class="col" id="txtInput">
                                            <div class="form-group row">
                                                <div class="col-lg-12">
                                                    <textarea class="js-maxlength form-control" id="example-maxlength10" name="example-maxlength10"  rows="10"  placeholder="Alasan Penolakan" maxlength="200" data-always-show="true"></textarea>
                                                </div>
                                            </div>
                                        </div>
...
<script>
    ...
    function checkedFunc(){
        value = $("input[name=radio-group12]:checked").val();
        txtInput = $("#txtInput");
